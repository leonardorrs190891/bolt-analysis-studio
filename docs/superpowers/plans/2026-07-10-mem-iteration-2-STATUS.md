...
| UFU (0.249) | c_bend 1-D | falhou | insensível — resíduo = mapear estados do Estágio A (D_init/emb_consumed) no runner |
...
| Karlsen HV (0.094) | C_creep do par + refit c_bend | falhou (0.127 no melhor) | **achado físico**: o C_creep UFU inflado absorvia outro mecanismo; o paper aponta dano de asperezas ("not creep") → **candidato pré-registrado de falsificação** (colapso virgem dirigido por D) |
...
4. Estados Stage-A no runner (UFU); re-derivação §4.29 (fig5); forma graded
