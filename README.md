...
self-arrest both emerge from that feedback. Every number in the companion paper
and in the software annex is recomputed from this repository by the generators
listed below.

**Authors.** Prof. Leonardo Rosa Ribeiro da Silva, PhD (leorrs@ancora_interna.br),
...
analyses of the group at âncora interna and is released openly so that the same analyses
...
| `New_Theory/build_paper_docx.py`, `build_annex_docx.py` | Generators of the manuscript and of the software annex (Word) |
...
5. **Documents**: reports, annex and manuscript are generated from the store;
