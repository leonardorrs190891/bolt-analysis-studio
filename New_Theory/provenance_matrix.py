...
def write_md(rows, wb, kws, sh):
    ...
    A("saiu do fit compartilhado na escala da âncora interna. A faixa [3, 15] saiu de ler o")
    ...
    A("   assentamento** (item 8, âncora interna: *\"dado plano até N≈38 e o modelo assenta")
