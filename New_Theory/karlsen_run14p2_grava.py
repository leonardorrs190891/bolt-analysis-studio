# -*- coding: utf-8 -*-
"""Escrita do store para o D-Z (copia do gravador do D-Y, alvo trocado) — re-simula so' o KARLSEN, re-carimba o resto.
...
def main() -> int:
    ...
    assert mudou == ["karlsen2022_M30_HVtorqued_run14p2"], "isolamento quebrado"
